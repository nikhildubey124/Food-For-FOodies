...
<head>
	<meta charset="UTF-8">
	<title>Brevrages - FOOD FOR FOODIES</title>
	...
	<div id="contents">
		<div>
			<div class="body"  id="gallery">
				<ul class="tabs">
					<li>
						<a href="gallery1.php">drinks</a>
					</li>
					<li class="selected">
						<a href="gallery3.php">soup</a>
					</li>
				</ul>
				<h1>Brevreges</h1>
				<ul class="items">
					...
					<li>
						<div class="frame">
							<img src="images/q.jpg" alt="Img">
						</div>
						<h2>MIX VEGETABLE SOUP</h2>
						<span class="price">RS 150.00</span>
					</li>
					<li>
						<div class="frame">
